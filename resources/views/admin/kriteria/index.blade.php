...
@section('title','Kriteria page admin')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{route('admin.kriteria.create')}}" class="btn btn-primary mb-3"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalImporLabel">Import Kriteria</h5>
