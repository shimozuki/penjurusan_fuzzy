...
@section('title','Tambah penyeleksian page admin')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah penyeleksian</h1>
        {{ Breadcrumbs::render('tambah_penyeleksian') }}
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.penyeleksian.store')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                placeholder="Tanggal penilaian" value="{{old('tanggal_penilaian')}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                placeholder="Judul penilaian" value="{{old('judul_penilaian')}}" name="judul_penilaian">
