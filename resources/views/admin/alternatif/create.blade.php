...
@section('title','Tambah alternatif page admin')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        {{ Breadcrumbs::render('tambah_alternatif') }}
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.alternatif.store')}}" method="post" class="form-submit">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_warga') border border-danger @enderror"
                                placeholder="Nama warga" value="{{old('nama_warga')}}" name="nama_warga">
                            @error('nama_warga')
                        ...
                        <div class="form-group">
                            ...
                            <?php 
                            $pernikahan_warga = old('pernikahan_warga');
                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                placeholder="Pekerjaan warga" value="{{old('pekerjaan_warga')}}" name="pekerjaan_warga">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Penghasilan suami" value="{{old('penghasilansuami_warga')}}"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Penghasilan istri" value="{{old('penghasilanistri_warga')}}"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Pekerjaan warga" value="{{old('penghasilanpribadi_warga')}}"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Total penghasilan" value="{{old('totalpenghasilan_warga')}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                placeholder="Tanggungan" value="{{old('tanggungan_warga')}}" name="tanggungan_warga">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('umur_warga') border border-danger @enderror"
                                placeholder="Umur" value="{{old('umur_warga')}}" name="umur_warga">
                            @error('umur_warga')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php 
                            $pendidikanterakhir_warga = old('pendidikanterakhir_warga');
                            ?>
                            <select
