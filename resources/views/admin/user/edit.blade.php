...
@section('title','edit user page admin')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.user.update', $user->id)}}" method="post"
                        ...
                        <div class="form-group">
                            <label for="password">Password <small class="text-info">* Kosongkan password jika tidak
                                    ingin ubah</small></label>
                            <input type="password"
                        ...
                        <div class="form-group">
                            <label for="password_confirmation">Password Confirmation <small class="text-info">*
                                    Kosongkan password jika tidak ingin ubah</small></label>
                            <input type="password"
                                class="form-control @error('password_confirmation') border border-danger @enderror"
                                placeholder="Password confirmation" value="" name="password_confirmation">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Nama profile" value="{{$user->nama_profile}}" name="nama_profile">
                                    @error('nama_profile')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0"
                                        ...
                                        placeholder="No. Handphone" value="{{$user->no_hp}}" name="no_hp">
                                    @error('no_hp')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
