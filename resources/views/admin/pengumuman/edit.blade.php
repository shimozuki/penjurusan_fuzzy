                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.pengumuman.update',$pengumuman->id)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <?php 
                            $penilaianId = $pengumuman->penilaian_id;
                            ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ CheckHelp::get_tanggal_show($pengumuman->tanggal_pengumuman)}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status_pengumuman"
                                            id="status_pengumuman1" value="buka"
                                            {{$pengumuman->status_pengumuman=='buka'
                                        ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status_pengumuman"
                                            id="status_pengumuman2" value="tutup"
                                            {{$pengumuman->status_pengumuman=='tutup'
                                        ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                placeholder="Judul pengumuman" value="{{$pengumuman->judul_pengumuman}}"
                        ...
                        <div class="form-group">
                            ...
                            {{$pengumuman->keterangan_pengumuman}}
                            </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                placeholder="Kuota pengumuman"
                                value="{{old('kuota_pengumuman') ?? $pengumuman->kuota_pengumuman}}"
