...
@section('title','Tambah verifikasi page admin')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah verifikasi</h1>
        {{ Breadcrumbs::render('tambah_verifikasi') }}
    </div>
                    ...
                    <form action="{{route('admin.verifikasi.store')}}" method="post">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Tanggal" value="{{  old('tanggal') }}" name="tanggal">
                                    @error('tanggal')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="waktu" value="{{old('waktu')}}" name="waktu">
                                    @error('waktu')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                placeholder="Judul Verifikasi" value="{{old('judul_verifikasi')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_verifikasi"
                                    id="status_verifikasi1" value="1" {{old('status_verifikasi')=='1' ? 'checked' : ''
                                    }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_verifikasi"
                                    id="status_verifikasi2" value="0" {{old('status_verifikasi')=='0' ? 'checked' : ''
                                    }}>
